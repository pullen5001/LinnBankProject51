...
public class PDFGenerator {
    ...
    public static void pdfGeneratorRowsAndCellsWithListFirstToTen(String header, List <Customer> list, String fileName){
        ...
        try{
            ...
            document.add(table);
            // document.add(image.getInstance(logo_path));     //eger pdf'e logo eklemekm istersek
            document.close();
